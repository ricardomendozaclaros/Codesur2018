<?php
class Admin_Form_Contacto_Voluntariadopdf extends Zend_Form {
	public function init() {
		...
		$this->addElement('select','pdf_tipó',array(
			'label'      => 'Posición Imagen',
			'multioptions'=>array(''=>'Selecciona una Opción',1=>'En el menu',0=>'Mostrar en pagina'),
			'required'   => true,
                        'value'=>1
		));

...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../upload/imagenes/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../upload/imagenes/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 2 * 1024 * 1024 ); //by bytes

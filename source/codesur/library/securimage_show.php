...
$img->image_width = 275;
$img->image_height = 90;
$img->perturbation =(float)(rand(6,9)/10); // 1.0 = high distortion, higher numbers = more distortion
//$img->image_bg_color = new Securimage_Color("#0099CC");
$img->text_color = new Securimage_Color("#A0A0A0");
//$img->text_transparency_percentage = 65; // 100 = completely transparent
$img->num_lines = (int)rand(6,10);
$img->line_color = new Securimage_Color("#F0F0F0");
